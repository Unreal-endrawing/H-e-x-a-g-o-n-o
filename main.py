...
#TF am i doing
PicTp = "IMG_1309.png"
BuildVersion = "0.0.0 Azucar mascabado"
...
class Mainwindows(QMainWindow):
    def __init__(self):
        ...
        Button3 = QPushButton("Cool Stuf for the future")
...
class CarbonEntryCreator(QWidget):
    def __init__(self):
        super().__init__()
        layout1 = QVBoxLayout()
        self.label = QLabel("Carbon editor to e up and running in milestone 2!!")
...
class FutureCoolStuf(QWidget):
    def __init__(self):
        super().__init__()
        layout4 = QVBoxLayout()
        self.label = QLabel("Milestone 1 - A Menu you can click! - You are here")
        self.label1 = QLabel("Milestone 2 - Carbon saves files")
